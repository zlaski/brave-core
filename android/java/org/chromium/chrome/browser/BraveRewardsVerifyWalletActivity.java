...
public class BraveRewardsVerifyWalletActivity extends Activity {
    ...
    void setTextForWalletTypes() {
        ...
        verifyWalletBenefitText1.setText(walletType.equals(BraveWalletProvider.UPHOLD) ? getResources().getString(R.string.verify_wallet_uphold_benefits1) : getResources().getString(R.string.verify_wallet_bitflyer_benefits1));
        TextView verifyWalletBenefitText2 = (TextView)findViewById(R.id.verify_wallet_benefit_2);
        verifyWalletBenefitText2.setText(walletType.equals(BraveWalletProvider.UPHOLD) ? getResources().getString(R.string.verify_wallet_uphold_benefits2) : getResources().getString(R.string.verify_wallet_bitflyer_benefits2));
        TextView verifyWalletBenefitText3 = (TextView)findViewById(R.id.verify_wallet_benefit_3);
        verifyWalletBenefitText3.setText(walletType.equals(BraveWalletProvider.UPHOLD) ? getResources().getString(R.string.verify_wallet_uphold_benefits3) : getResources().getString(R.string.verify_wallet_bitflyer_benefits3));

        TextView verifyWalletProviderNoteText = (TextView)findViewById(R.id.verify_wallet_provider_note_txt);
        verifyWalletProviderNoteText.setText(String.format(getResources().getString(R.string.verify_wallet_provider_note1), walletTypeString));

        TextView verifyWalletBraveNoteText = (TextView)findViewById(R.id.verify_wallet_brave_note_txt);
        verifyWalletBraveNoteText.setText(String.format(getResources().getString(R.string.verify_wallet_brave_note1), walletTypeString));
    }
    ...
    void SetVerifyWalletBtnClickHandler() {
        ...
        btnVerifyWallet.setOnClickListener( (View v) -> {
            ...
            Log.e("NTP", "Verify Url : "+verify_url);
