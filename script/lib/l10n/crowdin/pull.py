...
from lib.l10n.grd_utils import (get_grd_strings,
                                ...
                                get_xtb_files)
from lib.l10n.crowdin.common import (get_acceptable_json_lang_codes,
                                     get_crowdin_client_wrapper,
                                     get_strings_dict_from_xml_content,
                                     textify_from_crowdin,
                                     crowdin_name_from_filename,
...
def pull_source_file_from_crowdin(channel, source_file_path, filename,
    ...
    if ext == '.grd':
        ...
        for (lang_code, xtb_rel_path) in xtb_files:
            ...
            xml_content = get_crowdin_translation_file_content(channel,
        ...
        for lang_code in lang_codes:
            ...
            content = get_crowdin_translation_file_content(channel,
                source_file_path, filename, lang_code, dump_path)
...
def get_crowdin_translation_file_content(channel, source_file_path, filename,
    ...
    ext = os.path.splitext(source_file_path)[1]
    content = get_crowdin_client_wrapper().get_resource_l10n(channel,
