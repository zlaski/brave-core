...
#ifndef BRAVELEDGER_ENDPOINT_PROMOTION_POST_CLAIM_POST_CLAIM_BITFLYER_H_
#define BRAVELEDGER_ENDPOINT_PROMOTION_POST_CLAIM_POST_CLAIM_BITFLYER_H_
...
#endif  // BRAVELEDGER_ENDPOINT_PROMOTION_POST_CLAIM_POST_CLAIM_BITFLYER_H_
