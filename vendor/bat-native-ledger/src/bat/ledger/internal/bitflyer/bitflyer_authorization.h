...
#ifndef BRAVELEDGER_BITFLYER_BITFLYER_AUTHORIZATION_H_
#define BRAVELEDGER_BITFLYER_BITFLYER_AUTHORIZATION_H_
...
#endif  // BRAVELEDGER_BITFLYER_BITFLYER_AUTHORIZATION_H_
