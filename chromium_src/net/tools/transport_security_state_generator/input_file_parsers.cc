...
bool ParseJSON(base::StringPiece json,
  ...
  base::StringPiece brave_json = R"brave_json({
    ...
    "entries": [
      ...
      { "name": "rewards-backup.brave.com", "policy": "custom", "mode": "force-https", "pins": "brave"},
      { "name": "rewards-dev-backup.brave.software", "policy": "custom", "mode": "force-https", "pins": "brave"},
      { "name": "rewards-stg-backup.bravesoftware.com", "policy": "custom", "mode": "force-https", "pins": "brave"},
