...
const wchar_t kRegPathClients[] = L"Software\\PoltoonLtd\\Update\\Clients";
const wchar_t kRegPathClientState[] =
    L"Software\\PoltoonLtd\\Update\\ClientState";
const wchar_t kRegPathClientStateMedium[] =
    L"Software\\PoltoonLtd\\Update\\ClientStateMedium";
const wchar_t kRegPathGoogleUpdate[] = L"Software\\PoltoonLtd\\Update";
