...
#if defined(OFFICIAL_BUILD)
  return std::wstring(L"Software\\PoltoonLtd\\Update\\Clients\\")
      .append(app_guid);
#else
...
#if defined(OFFICIAL_BUILD)
  return std::wstring(L"Software\\PoltoonLtd\\Update\\ClientState\\")
      .append(app_guid);
#else
  return GetUnregisteredKeyPathForProduct();
#endif
...
#if defined(OFFICIAL_BUILD)
  return std::wstring(L"Software\\PoltoonLtd\\Update\\ClientStateMedium\\")
      .append(app_guid);
#else
  return GetUnregisteredKeyPathForProduct();
#endif
