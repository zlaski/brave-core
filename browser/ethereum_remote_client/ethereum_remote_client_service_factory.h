...
class EthereumRemoteClientServiceFactory : public BrowserContextKeyedServiceFactory {
 public:
  static EthereumRemoteClientService* GetForContext(content::BrowserContext* context);
  static EthereumRemoteClientServiceFactory* GetInstance();

 private:
  friend struct base::DefaultSingletonTraits<EthereumRemoteClientServiceFactory>;
