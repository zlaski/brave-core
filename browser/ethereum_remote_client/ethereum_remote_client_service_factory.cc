...
// static
EthereumRemoteClientServiceFactory* EthereumRemoteClientServiceFactory::GetInstance() {
...
KeyedService* EthereumRemoteClientServiceFactory::BuildServiceInstanceFor(
  ...
  return new EthereumRemoteClientService(context,
                                std::make_unique<EthereumRemoteClientDelegateImpl>());
}

content::BrowserContext* EthereumRemoteClientServiceFactory::GetBrowserContextToUse(
    content::BrowserContext* context) const {
