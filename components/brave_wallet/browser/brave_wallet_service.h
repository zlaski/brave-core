...
class BraveWalletService : public KeyedService,
 ...
 public:
  ...
  using SignMessageRequestCallback = base::OnceCallback<
      void(bool, mojom::SignatureBytesPtr, const std::optional<std::string>&)>;
  using SignSolTransactionsRequestCallback = base::OnceCallback<void(
      bool,
      std::optional<std::vector<mojom::SignatureBytesPtr>>,
