...
class DomainBlockControllerClient
 ...
 private:
  ...
  raw_ptr<AdBlockCustomFiltersSourceProvider> ad_block_custom_filters_source_provider_;
  raw_ptr<ephemeral_storage::EphemeralStorageService> ephemeral_storage_service_;
